...
let goods = [
  {
    ...
    url:'http://localhost:5002/photos/photo1.png'
  },
  {
    ...
    product_price: 21000,
    id: generateRandomId(8),
    url:'http://localhost:5002/photos/photo2.png'
  },
  {
    ...
    product_price: 34000,
    id: generateRandomId(8),
    url:'http://localhost:5002/photos/photo3.png'
  },
  {
    ...
    product_price: 68000,
    id: generateRandomId(8),
    url:'http://localhost:5002/photos/photo4.png'
  },
  {
    ...
    product_price: 40000,
    id: generateRandomId(8),
    url:'http://localhost:5002/photos/photo5.png'
  },
  {
    ...
    product_price: 80000,
    id: generateRandomId(8),
    url:'http://localhost:5002/photos/photo6.png'
  },
];
...
app.post("/add-orders", async (req, res) => {
  try {
    let obj = req.body;
    orders.push(obj);
    res.json({ text: `Заказ клиента ${obj.fullName} был добавлен` });
  } catch (error) {
